...
#   sed -i '' 's/?v=[0-9]*/?v=24/g' index.html
ASSET_V = 23
...
# 원본 1054x1584 -> 879x1584 (화면 비율에 가깝게).
# 가운데로 자르면 안 됩니다. 카메라가 아치 중심축보다 왼쪽에 있어서, 아치 다리는
# 대칭인데 꼭대기 곡선은 오른쪽으로 치우쳐 보입니다(원근). x0 을 66(다리 기준)
# 부터 106 까지 바꿔가며 화면에서 재보니 93 에서 곡선(+4px)과 다리(-3px)가
# 동시에 균형을 잡았습니다.
COVER_CROP = (0.088, 0.0, 0.922, 1.0)
