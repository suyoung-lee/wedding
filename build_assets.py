...
#   sed -i '' 's/?v=[0-9]*/?v=23/g' index.html
ASSET_V = 22
...
# 원본 974x1430 -> 793x1430 (화면 비율에 가깝게).
# 이 원본은 아치가 이미지 중심보다 19px 왼쪽에 있어서 가운데로 자르면 안 됩니다.
# x=72 부터 잘라야 아치가 표지 한가운데 옵니다 (측정: 아치 중심 x=468, 중심 487).
COVER_CROP = (0.074, 0.0, 0.888, 1.0)
